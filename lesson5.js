...
const questions = [
  ...
  {id: 5, answer: 'they are faster than us', done: false, textContent: 'Como se dice "Ellos son más rápidos que nosotros"?'},
  {id: 6, answer: 'you are slower than her', done: false, textContent: 'Como se dice "Tú eres más lento que ella"?'},
]

const questions2 = [
  {id: 7, answer: 'i will come in three days', done: false, textContent: 'Como se dice "Voy a venir en tres días"?'},
  {id: 8, answer: 'he left three days ago', done: false, textContent: 'Como se dice "Él se fue hace tres días"?'},
  {id: 9, answer: 'i will see you in one week', answer2: 'i will see you in one week', done: false, textContent: 'Como se dice "Te veré en una semana"?'},
  {id: 10, answer: 'i saw him two weeks ago', done: false, textContent: 'Como se dice "Lo vi hace dos semanas"?'},
  {id: 11, answer: 'yesterday i did not work but tomorrow i will work', done: false, textContent: 'Como se dice "Ayer no trabajé, pero mañana trabajaré"?'},
  {id: 12, answer: 'i will go to new york', done: false, textContent: 'Como se dice "Voy a ir a Nueva York"?'},
  {id: 13, answer: 'in one hour we will go home', answer2: 'in an hour we will go home', done: false, textContent: 'Como se dice "Te veré en una semana"?'},
  {id: 14, answer: 'i was here yesterday', done: false, textContent: 'Como se dice "Estuve aquí ayer"?'},
  {id: 15, answer: 'i will be here tomorrow', done: false, textContent: 'Como se dice "Estaré aquí mañana"?'}
]

const questions3 = [
  {id: 16, answer: 'i will come on monday', done: false, textContent: 'Como se dice "Voy a venir el lunes"?'},
  {id: 17, answer: 'i am yonger than him', done: false, textContent: 'Como se dice "Soy más joven que él"?'},
  {id: 18, answer: 'today i speak better than yesterday', done: false, textContent: 'Como se dice "Hoy hablo mejor que ayer"?'},
  {id: 19, answer: 'yesterday i spoke worse than today', done: false, textContent: 'Como se dice "Ayer hablé peor que hoy"?'},
  {id: 20, answer: 'today i am more interesting than yesterday', done: false, textContent: 'Como se dice "Hoy soy más interesante que ayer"?'},
  {id: 21, answer: 'november is shorter than october', done: false, textContent: 'Como se dice "Noviembre es más corto que octubre"?'},
  {id: 22, answer: 'february is the shortest month', done: false, textContent: 'Como se dice "Febrero es el mes más corto"?'},
  {id: 23, answer: 'texas is bigger than florida', done: false, textContent: 'Como se dice "Texas es más grande que Florida"?'},
  {id: 24, answer: 'i am the best student', done: false, textContent: 'Como se dice "Soy el mejor estudiante"?'},
  {id: 25, answer: 'i like summer more than winter', done: false, textContent: 'Como se dice "Me gusta más el verano que el invierno"?'}
]
