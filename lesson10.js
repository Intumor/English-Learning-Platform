...
const congratulate = () => {
  ...
  nextLessonButton.addEventListener('click', () => {
    if (lessonIsDone) {
      ...
      lessonIsDone = true;
      localStorage.setItem('lessons', JSON.stringify({1: 'complete', 2: 'complete', 3: 'complete', 4: 'complete', 5: "complete", 6: "complete", 7: "complete", 8: "complete", 9: "complete", 10: "complete", 11: "unlocked"}));
      localStorage.setItem('lesson10Status', lessonIsDone);
    }
  })
}